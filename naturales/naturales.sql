...
(
    ...
    constraint fk_rol foreign key (name_rol) references cliente.rol (name),
    constraint fk_customer_user foreign key (login) references cliente.customer_user (login)
);
...
(
    ...
    constraint fk_customer_user foreign key (login) references cliente.customer_user (login),
    constraint fk_tipo_documento foreign key (sigla) references cliente.tipo_documento (sigla),
...
CREATE table logs.log_errores(
    ...
    constraint fk_log_erro_cliente FOREIGN key (numero_documento,sigla) REFERENCES cliente.cliente(numero_documento,sigla)
)
...
create table logs.log_auditoria(
	...
	constraint fk_log_audi_clie FOREIGN key (numero_documento,sigla) REFERENCES cliente.cliente(numero_documento,sigla)
)
...
create table centro.area_instructor(
    ...
    constraint fk_intr_esin FOREIGN KEY (numero_documento,sigla) REFERENCES centro.intructor(numero_documento,sigla),
    constraint fk_area_esin FOREIGN KEY (nombre_area) REFERENCES centro.area (nombre_area)
)
...
create table centro.dia_jornada(
    ...
    constraint fk_jorn_dia_inst FOREIGN key (nombre_jornada) REFERENCES centro.jornada_instructor (nombre_jornada),
    constraint fk_dia_jorn_hora FOREIGN KEY (nombre_dia) REFERENCES horarios.dia (nombre_dia)
)
...
create Table ficha.trimestre(
    ...
    constraint fk_nifo_trim FOREIGN KEY (nivel) REFERENCES programa.nivel_formacion (nivel)
)
...
create table sede.ambiente(
    ...
    constraint fk_sede_ambi FOREIGN key (nombre_sede) REFERENCES sede.sede (nombre_Sede),
...
create table programa.programa (
    ...
    constraint fk_nifo_prog FOREIGN KEY (nivel) REFERENCES programa.nivel_formacion(nivel)
)
...
create table programa.competencia(
    ...
    constraint fk_prog_comp FOREIGN KEY (codigo_programa,version_programa) REFERENCES programa.programa(codigo,version)
)
...
create table programa.resultado_aprendizaje(
    ...
    constraint fk_comp_reap FOREIGN KEY (codigo_competencia,codigo_programa,version_programa) REFERENCES programa.competencia(codigo_competencia,codigo_programa,version_programa)
)
...
create table programa.planeacion_trimestre(
    ...
    constraint fk_reap_pltr FOREIGN KEY (codigo_resultado,codigo_competencia,codigo_programa,version_programa) REFERENCES programa.resultado_aprendizaje(codigo_resultado,codigo_competencia,codigo_programa,version_programa),
    constraint fk_plan_pltr FOREIGN KEY (codigo_planeacion) REFERENCES programa.planeacion (codigo),
    constraint fk_trim_pltr FOREIGN KEY (nombre_trimestre,nivel,sigla_jornada) REFERENCES ficha.trimestre (nombre_trimestre,nivel,sigla_jornada)
)
...
create table proyectos.proyecto(
    ...
    constraint fk_prog_proy FOREIGN KEY (codigo_programa,version_programa) REFERENCES programa.programa(codigo,version)
)
...
create table programa.actividad_planeacion(
    ...
    constraint fk_acti_acpl FOREIGN key (nombre_fase,numero_actividad,codigo_proyecto) REFERENCES proyectos.actividad_proyecto(nombre_fase,numero_actividad,codigo_proyecto)
);
...
CREATE TABLE centro.vinculacion_instructor(
    ...
    constraint fk_year_viin FOREIGN KEY (number_year) REFERENCES centro.year (number_year),
    constraint fk_inst_viin FOREIGN KEY (numero_documento,sigla) REFERENCES centro.intructor (numero_documento,sigla),
    constraint fk_vinc_viin FOREIGN KEY (tipo_vinculacion) REFERENCES centro.vinculacion(tipo_vinculacion)
)
...
create table centro.disponibilidad_competencias(
    ...
    constraint fk_viin_dico FOREIGN KEY (fecha_inicio,numero_documento,sigla,number_year,tipo_vinculacion) REFERENCES centro.vinculacion_instructor (fecha_inicio,numero_documento,sigla,number_year,tipo_vinculacion),
    constraint fk_comp_dico FOREIGN KEY (codigo_competencia,codigo_programa,version_programa) REFERENCES programa.competencia(codigo_competencia,codigo_programa,version_programa)
)
...
create table centro.disponibilidad_horaria(
    ...
    constraint fk_inst_hora FOREIGN KEY (fecha_inicio,numero_documento,sigla,number_year,tipo_vinculacion) REFERENCES centro.vinculacion_instructor (fecha_inicio,numero_documento,sigla,number_year,tipo_vinculacion),
    constraint fk_join_hora FOREIGN KEY (nombre_jornada) REFERENCES centro.jornada_instructor (nombre_jornada) 
)
...
create table sede.limitacion_ambiente(
    ...
    constraint fk_reap_liam FOREIGN KEY (codigo_resultado,codigo_competencia,codigo_programa,version_programa) REFERENCES programa.resultado_aprendizaje (codigo_resultado,codigo_competencia,codigo_programa,version_programa)
)
...
create table horarios.trimestre_vigente(
    ...
    constraint fk_year_vige FOREIGN KEY (number_year) REFERENCES centro.year (number_year) 
)
...
create table horarios.version_horario(
    ...
    constraint fk_trvi_veho FOREIGN KEY (trimestre_programado,number_year) REFERENCES horarios.trimestre_vigente (trimestre_programado,number_year)
)
...
create table ficha.ficha_has_trimestre(
    ...
    constraint fk_trim_fitr FOREIGN KEY (sigla_jornada,nivel,nombre_trimestre) REFERENCES ficha.trimestre (sigla_jornada,nivel,nombre_trimestre)
)
...
create table horarios.horario(
    ...
    constraint fk_fitr_hora FOREIGN KEY (numero_ficha,sigla_jornada,nivel,nombre_trimestre) REFERENCES ficha.ficha_has_trimestre (numero_ficha,sigla_jornada,nivel,nombre_trimestre),
    ...
    constraint fk_inst_hora FOREIGN KEY (sigla,numero_documento) REFERENCES centro.intructor (sigla,numero_documento)
)
...
create table ficha.ficha(
    ...
    constraint fk_jorn_fich FOREIGN KEY (sigla_jornada) REFERENCES ficha.jornada (sigla_jornada),
    constraint fk_prog_fich FOREIGN KEY (codigo,version) REFERENCES programa.programa (codigo,version)
)
...
create table ficha.ficha_planeacion(
    ...
    constraint fk_fich_plan FOREIGN KEY (numero_ficha) references ficha.ficha (numero_ficha),
    constraint fk_plan_plan FOREIGN KEY (codigo_planeacion) REFERENCES programa.planeacion (codigo)
)
...
create table ficha.resultados_vistos(
    ...
    constraint fk_reap_revi FOREIGN KEY (codigo_resultado,codigo_competencia,codigo_programa,version_programa) REFERENCES programa.resultado_aprendizaje (codigo_resultado,codigo_competencia,codigo_programa,version_programa),
    constraint fk_plan_revi FOREIGN KEY (codigo_planeacion) REFERENCES programa.planeacion (codigo)
)
...
create table ficha.aprendiz(
    ...
    constraint fk_fich_apre FOREIGN KEY (numero_ficha) REFERENCES ficha.ficha (numero_ficha),
    constraint fk_clie_apre FOREIGN KEY (numero_documento,sigla) REFERENCES cliente.cliente (numero_documento,sigla)
)
...
create table sustentacion.integrantes_grupo(
    ...
    constraint fk_grpr_ingr FOREIGN KEY (numero_grupo,numero_ficha2) REFERENCES sustentacion.grupo_proyecto (numero_grupo,numero_ficha),
    constraint fk_apre_ingr FOREIGN KEY (numero_documento,sigla,numero_ficha) REFERENCES ficha.aprendiz (numero_documento,sigla,numero_ficha)
)